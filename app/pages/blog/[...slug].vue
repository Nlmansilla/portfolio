<template>
    <article class="prose max-w-none dark:prose-invert prose-pre:bg-white
        ...
        <ContentDoc>
            ...
            <template v-slot="{ doc }">
                <div class="grid grid-cols-6 gap-16">
                    <div :class="{ 'col-span-6 md:col-span-4': doc.toc, 'col-span-6': !doc.toc }">                    <ContentRenderer :value="doc" />
                </div>
